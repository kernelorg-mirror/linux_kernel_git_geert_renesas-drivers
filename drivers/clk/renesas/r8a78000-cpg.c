					  ...
					  const struct clk_map_in *map_in)
{
	...
	for (i = 0; ; i++) {
		...
		if (!hw)
			return dev_err_ptr_probe(dev, -ENOENT,
						 "SCMI clock %u is NULL!\n",
						 map[i].fw_id);
...
static const struct clk_map_in r8a78000_cpg_fw_1_10_0[] = {
...
static const struct fw_map r8a78000_cpg_fw_map[] = {
	{ 0x010a0000, r8a78000_cpg_fw_1_10_0 },	/* SCP FW SDKv4.28.0 */
	{ 0, NULL }
};
