...
static const struct configfs_item_operations cfs_overlay_item_ops = {
...
static const struct configfs_group_operations overlays_ops = {
...
static const struct configfs_group_operations of_cfs_ops = {
