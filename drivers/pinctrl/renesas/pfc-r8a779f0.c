...
#define CPU_ALL_GP(fn, sfx)	\
	...
	PORT_GP_CFG_23(6, fn, sfx, CFG_FLAGS),	\
	PORT_GP_1(6, 23, fn, sfx), \
	...
	PORT_GP_CFG_1(6, 31, fn, sfx, CFG_FLAGS), \
	PORT_GP_CFG_32(7, fn, sfx, CFG_FLAGS)

#define CPU_ALL_NOGP(fn)								\
	PIN_NOGP_CFG(PRESETOUT0_N, "PRESETOUT0#", fn, SH_PFC_PIN_CFG_PULL_DOWN),	\
	PIN_NOGP_CFG(EXTALR, "EXTALR", fn, SH_PFC_PIN_CFG_PULL_UP_DOWN),		\
	PIN_NOGP_CFG(ERROROUT_M_N, "ERROROUT_M#", fn, SH_PFC_PIN_CFG_PULL_UP_DOWN),	\
	PIN_NOGP_CFG(DCUTRST0_N, "DCUTRST0#", fn, SH_PFC_PIN_CFG_PULL_DOWN),		\
	PIN_NOGP_CFG(DCUTRST1_N, "DCUTRST1#", fn, SH_PFC_PIN_CFG_PULL_DOWN),		\
	PIN_NOGP_CFG(DCUTCK0, "DCUTCK0", fn, SH_PFC_PIN_CFG_PULL_DOWN),			\
	PIN_NOGP_CFG(DCUTDI0, "DCUTDI0", fn, SH_PFC_PIN_CFG_PULL_DOWN),			\
	PIN_NOGP_CFG(DCUTMS0, "DCUTMS0", fn, SH_PFC_PIN_CFG_PULL_DOWN),			\
	PIN_NOGP_CFG(DCUTMS1, "DCUTMS1", fn, SH_PFC_PIN_CFG_PULL_DOWN),			\
	PIN_NOGP_CFG(DCUTDI1, "DCUTDI1", fn, SH_PFC_PIN_CFG_PULL_DOWN),			\
	PIN_NOGP_CFG(DCUTCK1, "DCUTCK1", fn, SH_PFC_PIN_CFG_PULL_DOWN),			\
	PIN_NOGP_CFG(EVTI_N, "EVTI#", fn, SH_PFC_PIN_CFG_PULL_DOWN),			\
	PIN_NOGP_CFG(MSYN_N, "MSYN#", fn, SH_PFC_PIN_CFG_PULL_DOWN)
...
/* GPSR4 */
#define GPSR4_30	F_(MSPI1CSS1_B,		IP3SR4_27_24)
#define GPSR4_29	F_(MSPI1CSS2_B,		IP3SR4_23_20)
#define GPSR4_28	F_(MSPI1SC,		IP3SR4_19_16)
#define GPSR4_27	F_(MSPI1CSS0_B,		IP3SR4_15_12)
#define GPSR4_26	F_(MSPI1SO_MSPI1DCS,	IP3SR4_11_8)
#define GPSR4_25	F_(MSPI1SI_B,		IP3SR4_7_4)
...
#define GPSR6_22	FM(NMI1_B)
#define GPSR6_21	F_(INTP32_B,		IP2SR6_11_8)
#define GPSR6_20	FM(INTP33_B)
#define GPSR6_19	FM(INTP34_B)
#define GPSR6_18	FM(INTP35_B)
#define GPSR6_17	F_(INTP36_B,		IP2SR6_7_4)
#define GPSR6_16	F_(INTP37_B,		IP2SR6_3_0)
...
#define GPSR6_7		F_(RLIN34RX_INTP20_B,	IP0SR6_31_28)
#define GPSR6_6		F_(RLIN34TX_B,		IP0SR6_27_24)
#define GPSR6_5		F_(RLIN35RX_INTP21_B,	IP0SR6_23_20)
#define GPSR6_4		F_(RLIN35TX_B,		IP0SR6_19_16)
#define GPSR6_3		F_(RLIN36RX_INTP22_B,	IP0SR6_15_12)
#define GPSR6_2		F_(RLIN36TX_B,		IP0SR6_11_8)
#define GPSR6_1		F_(RLIN37RX_INTP23_B,	IP0SR6_7_4)
#define GPSR6_0		F_(RLIN37TX_B,		IP0SR6_3_0)

/* GPSR7 */
#define GPSR7_31	F_(CAN15RX_INTP15_B,	IP3SR7_31_28)
#define GPSR7_30	F_(CAN15TX_B,		IP3SR7_27_24)
#define GPSR7_29	F_(CAN14RX_INTP14_B,	IP3SR7_23_20)
#define GPSR7_28	F_(CAN14TX_B,		IP3SR7_19_16)
#define GPSR7_27	F_(CAN13RX_INTP13_B,	IP3SR7_15_12)
#define GPSR7_26	F_(CAN13TX_B,		IP3SR7_11_8)
#define GPSR7_25	F_(CAN12RX_INTP12_B,	IP3SR7_7_4)
#define GPSR7_24	F_(CAN12TX_B,		IP3SR7_3_0)
...
#define IP0SR4_15_12	FM(GP4_03)		FM(MSPI4CSS1)		F_(0, 0)		FM(TAUD0I6)		FM(TAUD0O6)	FM(MSPI5SO_MSPI5DCS_A)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR4_19_16	FM(GP4_04)		FM(MSPI4CSS0)		FM(MSPI4SSI_N)		FM(TAUD0I5)		FM(TAUD0O5)	FM(MSPI5SC_A)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR4_23_20	FM(GP4_05)		FM(MSPI4CSS3)		F_(0, 0)		FM(TAUD0I8)		FM(TAUD0O8)	FM(MSPI5SSI_N_A)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR4_27_24	FM(GP4_06)		FM(MSPI4CSS2)		F_(0, 0)		FM(TAUD0I7)		FM(TAUD0O7)	FM(MSPI5SI_A)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR4_31_28	FM(GP4_07)		FM(MSPI4CSS5)		F_(0, 0)		FM(TAUD0I10)		FM(TAUD0O10)	FM(MSPI5CSS1_A)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
/* IP1SR4 */		/* 0 */			/* 1 */			/* 2 */			/* 3 */			/* 4 */		/* 5 */			/* 6 */			/* 7 - F */
#define IP1SR4_3_0	FM(GP4_08)		FM(MSPI4CSS4)		F_(0, 0)		FM(TAUD0I9)		FM(TAUD0O9)	FM(MSPI5CSS0_A)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR4_7_4	FM(GP4_09)		FM(MSPI4CSS7)		F_(0, 0)		FM(TAUD0I12)		FM(TAUD0O12)	FM(MSPI5CSS3_A)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR4_11_8	FM(GP4_10)		FM(MSPI4CSS6)		F_(0, 0)		FM(TAUD0I11)		FM(TAUD0O11)	FM(MSPI5CSS2_A)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
#define IP3SR4_7_4	FM(MSPI1SI_B)		F_(0, 0)		FM(MSPI0CSS4_B)		FM(TAUD1I12_B)		FM(TAUD1O12_B)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
#define IP3SR4_15_12	FM(MSPI1CSS0_B)		FM(MSPI1SSI_N_B)	FM(MSPI0CSS5_B)		FM(TAUD1I13_B)		FM(TAUD1O13_B)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
#define IP3SR4_23_20	FM(MSPI1CSS2_B)		F_(0, 0)		FM(MSPI0CSS7_B)		FM(TAUD1I15_B)		FM(TAUD1O15_B)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP3SR4_27_24	FM(MSPI1CSS1_B)		F_(0, 0)		FM(MSPI0CSS6_B)		FM(TAUD1I14_B)		FM(TAUD1O14_B)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
#define IP0SR5_11_8	FM(ETNB0MD)		FM(MSPI1CSS1_A)		F_(0, 0)		FM(MSPI0CSS6_A)		FM(TAUD1I14_A)	FM(TAUD1O14_A)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR5_15_12	FM(ETNB0WOL)		FM(MSPI1SI_A)		F_(0, 0)		FM(MSPI0CSS4_A)		FM(TAUD1I12_A)	FM(TAUD1O12_A)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR5_19_16	FM(ETNB0LINKSTA)	FM(MSPI1CSS0_A)		FM(MSPI1SSI_N_A)	FM(MSPI0CSS5_A)		FM(TAUD1I13_A)	FM(TAUD1O13_A)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR5_23_20	FM(ETNB0MDC)		FM(MSPI1CSS2_A)		F_(0, 0)		FM(MSPI0CSS7_A)		FM(TAUD1I15_A)	FM(TAUD1O15_A)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
/* IP0SR6 */		/* 0 */			/* 1 */			/* 2 */			/* 3 */			/* 4 */		/* 5 */			/* 6 */			/* 7 - F */
#define IP0SR6_3_0	FM(RLIN37TX_B)		FM(MSPI5CSS3_B)		F_(0, 0)		F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR6_7_4	FM(RLIN37RX_INTP23_B)	FM(MSPI5CSS2_B)		F_(0, 0)		F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR6_11_8	FM(RLIN36TX_B)		FM(MSPI5CSS1_B)		F_(0, 0)		F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR6_15_12	FM(RLIN36RX_INTP22_B)	FM(MSPI5CSS0_B)		F_(0, 0)		F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR6_19_16	FM(RLIN35TX_B)		FM(MSPI5SSI_N_B)	F_(0, 0)		F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR6_23_20	FM(RLIN35RX_INTP21_B)	FM(MSPI5SI_B)		F_(0, 0)		F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR6_27_24	FM(RLIN34TX_B)		FM(MSPI5SO_MSPI5DCS_B)	F_(0, 0)		F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR6_31_28	FM(RLIN34RX_INTP20_B)	FM(MSPI5SC_B)		F_(0, 0)		F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
/* IP1SR6 */		/* 0 */			/* 1 */			/* 2 */			/* 3 */			/* 4 */		/* 5 */			/* 6 */			/* 7 - F */
#define IP1SR6_3_0	FM(RLIN33TX)		F_(0, 0)		F_(0, 0)		FM(TAUJ3O3)		FM(TAUJ3I3)	FM(NMI1_A)		FM(CAN15TX_A)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR6_7_4	FM(RLIN33RX_INTP19)	F_(0, 0)		F_(0, 0)		FM(TAUJ3O2)		FM(TAUJ3I2)	FM(INTP37_A)		FM(CAN15RX_INTP15_A)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR6_11_8	FM(RLIN32TX)		F_(0, 0)		F_(0, 0)		FM(TAUJ3O1)		FM(TAUJ3I1)	FM(INTP36_A)		FM(CAN14TX_A)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR6_15_12	FM(RLIN32RX_INTP18)	F_(0, 0)		F_(0, 0)		FM(TAUJ3O0)		FM(TAUJ3I0)	FM(INTP35_A)		FM(CAN14RX_INTP14_A)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR6_19_16	FM(RLIN31TX)		F_(0, 0)		F_(0, 0)		FM(TAUJ1I3)		FM(TAUJ1O3)	FM(INTP34_A)		FM(CAN13TX_A)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR6_23_20	FM(RLIN31RX_INTP17)	F_(0, 0)		F_(0, 0)		FM(TAUJ1I2)		FM(TAUJ1O2)	FM(INTP33_A)		FM(CAN13RX_INTP13_A)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR6_27_24	FM(RLIN30TX)		F_(0, 0)		F_(0, 0)		FM(TAUJ1I1)		FM(TAUJ1O1)	FM(INTP32_A)		FM(CAN12TX_A)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR6_31_28	FM(RLIN30RX_INTP16)	F_(0, 0)		F_(0, 0)		FM(TAUJ1I0)		FM(TAUJ1O0)	F_(0, 0)		FM(CAN12RX_INTP12_A)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
/* IP2SR6 */		/* 0 */			/* 1 */			/* 2 */			/* 3 */			/* 4 */		/* 5 */			/* 6 */			/* 7 - F */
#define IP2SR6_3_0	FM(INTP37_B)		F_(0, 0)		FM(EXTCLK0O_B)		F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP2SR6_7_4	FM(INTP36_B)		FM(RTCA0OUT_B)		F_(0, 0)		F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP2SR6_11_8	FM(INTP32_B)		F_(0, 0)		FM(FLXA0STPWT)		F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
/* IP0SR7 */		/* 0 */			/* 1 */			/* 2 */			/* 3 */			/* 4 */		/* 5 */			/* 6 */			/* 7 - F */
#define IP0SR7_3_0	FM(CAN0TX)		FM(RSENT0SPCO)		F_(0, 0)		FM(MSPI2SO_MSPI2DCS)	F_(0, 0)	FM(RLIN34TX_A)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR7_7_4	FM(CAN0RX_INTP0)	FM(RSENT0RX)		FM(RSENT0RX_RSENT0SPCO)	FM(MSPI2SC)		F_(0, 0)	FM(RLIN34RX_INTP20_A)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR7_11_8	FM(CAN1TX)		FM(RSENT1SPCO)		F_(0, 0)		FM(MSPI2SSI_N)		FM(MSPI2CSS0)	FM(RLIN35TX_A)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR7_15_12	FM(CAN1RX_INTP1)	FM(RSENT1RX)		FM(RSENT1RX_RSENT1SPCO)	FM(MSPI2SI)		F_(0, 0)	FM(RLIN35RX_INTP21_A)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR7_19_16	FM(CAN2TX)		FM(RSENT2SPCO)		F_(0, 0)		F_(0, 0)		FM(MSPI2CSS2)	FM(RLIN36TX_A)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR7_23_20	FM(CAN2RX_INTP2)	FM(RSENT2RX)		FM(RSENT2RX_RSENT2SPCO)	F_(0, 0)		FM(MSPI2CSS1)	FM(RLIN36RX_INTP22_A)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR7_27_24	FM(CAN3TX)		FM(RSENT3SPCO)		F_(0, 0)		F_(0, 0)		FM(MSPI2CSS4)	FM(RLIN37TX_A)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0SR7_31_28	FM(CAN3RX_INTP3)	FM(RSENT3RX)		FM(RSENT3RX_RSENT3SPCO)	F_(0, 0)		FM(MSPI2CSS3)	FM(RLIN37RX_INTP23_A)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
/* IP1SR7 */		/* 0 */			/* 1 */			/* 2 */			/* 3 */			/* 4 */		/* 5 */			/* 6 */			/* 7 - F */
#define IP1SR7_3_0	FM(CAN4TX)		FM(RSENT4SPCO)		F_(0, 0)		F_(0, 0)		FM(MSPI2CSS6)	FM(RLIN312TX_A)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR7_7_4	FM(CAN4RX_INTP4)	FM(RSENT4RX)		FM(RSENT4RX_RSENT4SPCO)	F_(0, 0)		FM(MSPI2CSS5)	FM(RLIN312RX_INTP28_A)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR7_11_8	FM(CAN5TX)		FM(RSENT5SPCO)		F_(0, 0)		F_(0, 0)		F_(0, 0)	FM(RLIN313TX_A)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR7_15_12	FM(CAN5RX_INTP5)	FM(RSENT5RX)		FM(RSENT5RX_RSENT5SPCO)	F_(0, 0)		FM(MSPI2CSS7)	FM(RLIN313RX_INTP29_A)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR7_19_16	FM(CAN6TX)		FM(RSENT6SPCO)		F_(0, 0)		FM(MSPI3SO_MSPI3DCS)	F_(0, 0)	FM(RLIN314TX_A)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR7_23_20	FM(CAN6RX_INTP6)	FM(RSENT6RX)		FM(RSENT6RX_RSENT6SPCO)	FM(MSPI3SC)		F_(0, 0)	FM(RLIN314RX_INTP30_A)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR7_27_24	FM(CAN7TX)		FM(RSENT7SPCO)		F_(0, 0)		FM(MSPI3SSI_N)		F_(0, 0)	FM(RLIN315TX_A)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1SR7_31_28	FM(CAN7RX_INTP7)	FM(RSENT7RX)		FM(RSENT7RX_RSENT7SPCO)	FM(MSPI3SI)		F_(0, 0)	FM(RLIN315RX_INTP31_A)	F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
/* IP2SR7 */		/* 0 */			/* 1 */			/* 2 */			/* 3 */			/* 4 */		/* 5 */			/* 6 */			/* 7 - F */
...
#define IP2SR7_27_24	FM(CAN11TX)		FM(RLIN311TX)		F_(0, 0)		FM(MSPI3CSS7)		F_(0, 0)	F_(0, 0)		FM(RTCA0OUT_A)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP2SR7_31_28	FM(CAN11RX_INTP11)	FM(RLIN311RX_INTP27)	F_(0, 0)		FM(MSPI3CSS6)		F_(0, 0)	F_(0, 0)		FM(EXTCLK0O_A)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
/* IP3SR7 */		/* 0 */			/* 1 */			/* 2 */			/* 3 */			/* 4 */		/* 5 */			/* 6 */			/* 7 - F */
#define IP3SR7_3_0	FM(CAN12TX_B)		FM(RLIN312TX_B)		F_(0, 0)		F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP3SR7_7_4	FM(CAN12RX_INTP12_B)	FM(RLIN312RX_INTP28_B)	F_(0, 0)		F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP3SR7_11_8	FM(CAN13TX_B)		FM(RLIN313TX_B)		FM(FLXA0RXDB)		F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP3SR7_15_12	FM(CAN13RX_INTP13_B)	FM(RLIN313RX_INTP29_B)	FM(FLXA0RXDA)		F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP3SR7_19_16	FM(CAN14TX_B)		FM(RLIN314TX_B)		FM(FLXA0TXDB)		F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP3SR7_23_20	FM(CAN14RX_INTP14_B)	FM(RLIN314RX_INTP30_B)	FM(FLXA0TXDA)		F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP3SR7_27_24	FM(CAN15TX_B)		FM(RLIN315TX_B)		FM(FLXA0TXENB)		F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP3SR7_31_28	FM(CAN15RX_INTP15_B)	FM(RLIN315RX_INTP31_B)	FM(FLXA0TXENA)		F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0)		F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
static const u16 pinmux_data[] = {
	...
	PINMUX_SINGLE(NMI1_B),
	PINMUX_SINGLE(INTP33_B),
	PINMUX_SINGLE(INTP34_B),
	PINMUX_SINGLE(INTP35_B),
	...
	PINMUX_IPSR_GPSR(IP0SR4_15_12,	MSPI5SO_MSPI5DCS_A),
	...
	PINMUX_IPSR_GPSR(IP0SR4_19_16,	MSPI5SC_A),
	...
	PINMUX_IPSR_GPSR(IP0SR4_23_20,	MSPI5SSI_N_A),
	...
	PINMUX_IPSR_GPSR(IP0SR4_27_24,	MSPI5SI_A),
	...
	PINMUX_IPSR_GPSR(IP0SR4_31_28,	MSPI5CSS1_A),
	...
	PINMUX_IPSR_GPSR(IP1SR4_3_0,	MSPI5CSS0_A),
	...
	PINMUX_IPSR_GPSR(IP1SR4_7_4,	MSPI5CSS3_A),
	...
	PINMUX_IPSR_GPSR(IP1SR4_11_8,	MSPI5CSS2_A),
	...
	PINMUX_IPSR_GPSR(IP3SR4_7_4,	MSPI1SI_B),
	PINMUX_IPSR_GPSR(IP3SR4_7_4,	MSPI0CSS4_B),
	PINMUX_IPSR_GPSR(IP3SR4_7_4,	TAUD1I12_B),
	PINMUX_IPSR_GPSR(IP3SR4_7_4,	TAUD1O12_B),
	...
	PINMUX_IPSR_GPSR(IP3SR4_15_12,	MSPI1CSS0_B),
	PINMUX_IPSR_GPSR(IP3SR4_15_12,	MSPI1SSI_N_B),
	PINMUX_IPSR_GPSR(IP3SR4_15_12,	MSPI0CSS5_B),
	PINMUX_IPSR_GPSR(IP3SR4_15_12,	TAUD1I13_B),
	PINMUX_IPSR_GPSR(IP3SR4_15_12,	TAUD1O13_B),
	...
	PINMUX_IPSR_GPSR(IP3SR4_23_20,	MSPI1CSS2_B),
	PINMUX_IPSR_GPSR(IP3SR4_23_20,	MSPI0CSS7_B),
	PINMUX_IPSR_GPSR(IP3SR4_23_20,	TAUD1I15_B),
	PINMUX_IPSR_GPSR(IP3SR4_23_20,	TAUD1O15_B),

	PINMUX_IPSR_GPSR(IP3SR4_27_24,	MSPI1CSS1_B),
	PINMUX_IPSR_GPSR(IP3SR4_27_24,	MSPI0CSS6_B),
	PINMUX_IPSR_GPSR(IP3SR4_27_24,	TAUD1I14_B),
	PINMUX_IPSR_GPSR(IP3SR4_27_24,	TAUD1O14_B),
	...
	PINMUX_IPSR_GPSR(IP0SR5_11_8,	MSPI1CSS1_A),
	PINMUX_IPSR_GPSR(IP0SR5_11_8,	MSPI0CSS6_A),
	PINMUX_IPSR_GPSR(IP0SR5_11_8,	TAUD1I14_A),
	PINMUX_IPSR_GPSR(IP0SR5_11_8,	TAUD1O14_A),

	PINMUX_IPSR_GPSR(IP0SR5_15_12,	ETNB0WOL),
	PINMUX_IPSR_GPSR(IP0SR5_15_12,	MSPI1SI_A),
	PINMUX_IPSR_GPSR(IP0SR5_15_12,	MSPI0CSS4_A),
	PINMUX_IPSR_GPSR(IP0SR5_15_12,	TAUD1I12_A),
	PINMUX_IPSR_GPSR(IP0SR5_15_12,	TAUD1O12_A),

	PINMUX_IPSR_GPSR(IP0SR5_19_16,	ETNB0LINKSTA),
	PINMUX_IPSR_GPSR(IP0SR5_19_16,	MSPI1CSS0_A),
	PINMUX_IPSR_GPSR(IP0SR5_19_16,	MSPI1SSI_N_A),
	PINMUX_IPSR_GPSR(IP0SR5_19_16,	MSPI0CSS5_A),
	PINMUX_IPSR_GPSR(IP0SR5_19_16,	TAUD1I13_A),
	PINMUX_IPSR_GPSR(IP0SR5_19_16,	TAUD1O13_A),

	PINMUX_IPSR_GPSR(IP0SR5_23_20,	ETNB0MDC),
	PINMUX_IPSR_GPSR(IP0SR5_23_20,	MSPI1CSS2_A),
	PINMUX_IPSR_GPSR(IP0SR5_23_20,	MSPI0CSS7_A),
	PINMUX_IPSR_GPSR(IP0SR5_23_20,	TAUD1I15_A),
	PINMUX_IPSR_GPSR(IP0SR5_23_20,	TAUD1O15_A),
	...
	/* IP0SR6 */
	PINMUX_IPSR_GPSR(IP0SR6_3_0,	RLIN37TX_B),
	PINMUX_IPSR_GPSR(IP0SR6_3_0,	MSPI5CSS3_B),

	PINMUX_IPSR_GPSR(IP0SR6_7_4,	RLIN37RX_INTP23_B),
	PINMUX_IPSR_GPSR(IP0SR6_7_4,	MSPI5CSS2_B),

	PINMUX_IPSR_GPSR(IP0SR6_11_8,	RLIN36TX_B),
	PINMUX_IPSR_GPSR(IP0SR6_11_8,	MSPI5CSS1_B),

	PINMUX_IPSR_GPSR(IP0SR6_15_12,	RLIN36RX_INTP22_B),
	PINMUX_IPSR_GPSR(IP0SR6_15_12,	MSPI5CSS0_B),

	PINMUX_IPSR_GPSR(IP0SR6_19_16,	RLIN35TX_B),
	PINMUX_IPSR_GPSR(IP0SR6_19_16,	MSPI5SSI_N_B),

	PINMUX_IPSR_GPSR(IP0SR6_23_20,	RLIN35RX_INTP21_B),
	PINMUX_IPSR_GPSR(IP0SR6_23_20,	MSPI5SI_B),

	PINMUX_IPSR_GPSR(IP0SR6_27_24,	RLIN34TX_B),
	PINMUX_IPSR_GPSR(IP0SR6_27_24,	MSPI5SO_MSPI5DCS_B),

	PINMUX_IPSR_GPSR(IP0SR6_31_28,	RLIN34RX_INTP20_B),
	PINMUX_IPSR_GPSR(IP0SR6_31_28,	MSPI5SC_B),

	/* IP1SR6 */
	PINMUX_IPSR_GPSR(IP1SR6_3_0,	RLIN33TX),
	PINMUX_IPSR_GPSR(IP1SR6_3_0,	TAUJ3O3),
	PINMUX_IPSR_GPSR(IP1SR6_3_0,	TAUJ3I3),
	PINMUX_IPSR_GPSR(IP1SR6_3_0,	NMI1_A),
	PINMUX_IPSR_GPSR(IP1SR6_3_0,	CAN15TX_A),

	PINMUX_IPSR_GPSR(IP1SR6_7_4,	RLIN33RX_INTP19),
	PINMUX_IPSR_GPSR(IP1SR6_7_4,	TAUJ3O2),
	PINMUX_IPSR_GPSR(IP1SR6_7_4,	TAUJ3I2),
	PINMUX_IPSR_GPSR(IP1SR6_7_4,	INTP37_A),
	PINMUX_IPSR_GPSR(IP1SR6_7_4,	CAN15RX_INTP15_A),

	PINMUX_IPSR_GPSR(IP1SR6_11_8,	RLIN32TX),
	PINMUX_IPSR_GPSR(IP1SR6_11_8,	TAUJ3O1),
	PINMUX_IPSR_GPSR(IP1SR6_11_8,	TAUJ3I1),
	PINMUX_IPSR_GPSR(IP1SR6_11_8,	INTP36_A),
	PINMUX_IPSR_GPSR(IP1SR6_11_8,	CAN14TX_A),

	PINMUX_IPSR_GPSR(IP1SR6_15_12,	RLIN32RX_INTP18),
	PINMUX_IPSR_GPSR(IP1SR6_15_12,	TAUJ3O0),
	PINMUX_IPSR_GPSR(IP1SR6_15_12,	TAUJ3I0),
	PINMUX_IPSR_GPSR(IP1SR6_15_12,	INTP35_A),
	PINMUX_IPSR_GPSR(IP1SR6_15_12,	CAN14RX_INTP14_A),

	PINMUX_IPSR_GPSR(IP1SR6_19_16,	RLIN31TX),
	PINMUX_IPSR_GPSR(IP1SR6_19_16,	TAUJ1I3),
	PINMUX_IPSR_GPSR(IP1SR6_19_16,	TAUJ1O3),
	PINMUX_IPSR_GPSR(IP1SR6_19_16,	INTP34_A),
	PINMUX_IPSR_GPSR(IP1SR6_19_16,	CAN13TX_A),

	PINMUX_IPSR_GPSR(IP1SR6_23_20,	RLIN31RX_INTP17),
	PINMUX_IPSR_GPSR(IP1SR6_23_20,	TAUJ1I2),
	PINMUX_IPSR_GPSR(IP1SR6_23_20,	TAUJ1O2),
	PINMUX_IPSR_GPSR(IP1SR6_23_20,	INTP33_A),
	PINMUX_IPSR_GPSR(IP1SR6_23_20,	CAN13RX_INTP13_A),

	PINMUX_IPSR_GPSR(IP1SR6_27_24,	RLIN30TX),
	PINMUX_IPSR_GPSR(IP1SR6_27_24,	TAUJ1I1),
	PINMUX_IPSR_GPSR(IP1SR6_27_24,	TAUJ1O1),
	PINMUX_IPSR_GPSR(IP1SR6_27_24,	INTP32_A),
	PINMUX_IPSR_GPSR(IP1SR6_27_24,	CAN12TX_A),

	PINMUX_IPSR_GPSR(IP1SR6_31_28,	RLIN30RX_INTP16),
	PINMUX_IPSR_GPSR(IP1SR6_31_28,	TAUJ1I0),
	PINMUX_IPSR_GPSR(IP1SR6_31_28,	TAUJ1O0),
	PINMUX_IPSR_GPSR(IP1SR6_31_28,	CAN12RX_INTP12_A),

	/* IP2SR6 */
	PINMUX_IPSR_GPSR(IP2SR6_3_0,	INTP37_B),
	PINMUX_IPSR_GPSR(IP2SR6_3_0,	EXTCLK0O_B),

	PINMUX_IPSR_GPSR(IP2SR6_7_4,	INTP36_B),
	PINMUX_IPSR_GPSR(IP2SR6_7_4,	RTCA0OUT_B),

	PINMUX_IPSR_GPSR(IP2SR6_11_8,	INTP32_B),
	...
	PINMUX_IPSR_GPSR(IP0SR7_3_0,	RLIN34TX_A),
	...
	PINMUX_IPSR_GPSR(IP0SR7_7_4,	RLIN34RX_INTP20_A),
	...
	PINMUX_IPSR_GPSR(IP0SR7_11_8,	RLIN35TX_A),
	...
	PINMUX_IPSR_GPSR(IP1SR7_7_4,	RLIN312RX_INTP28_A),

	PINMUX_IPSR_GPSR(IP1SR7_11_8,	CAN5TX),
	PINMUX_IPSR_GPSR(IP1SR7_11_8,	RSENT5SPCO),
	PINMUX_IPSR_GPSR(IP1SR7_11_8,	RLIN313TX_A),
	...
	PINMUX_IPSR_GPSR(IP1SR7_15_12,	RLIN313RX_INTP29_A),
	...
	PINMUX_IPSR_GPSR(IP1SR7_19_16,	RLIN314TX_A),
	...
	PINMUX_IPSR_GPSR(IP1SR7_31_28,	RLIN315RX_INTP31_A),
	...
	PINMUX_IPSR_GPSR(IP2SR7_27_24,	RTCA0OUT_A),
	...
	PINMUX_IPSR_GPSR(IP2SR7_31_28,	EXTCLK0O_A),

	/* IP3SR7 */
	PINMUX_IPSR_GPSR(IP3SR7_3_0,	CAN12TX_B),
	PINMUX_IPSR_GPSR(IP3SR7_3_0,	RLIN312TX_B),

	PINMUX_IPSR_GPSR(IP3SR7_7_4,	CAN12RX_INTP12_B),
	PINMUX_IPSR_GPSR(IP3SR7_7_4,	RLIN312RX_INTP28_B),

	PINMUX_IPSR_GPSR(IP3SR7_11_8,	CAN13TX_B),
	PINMUX_IPSR_GPSR(IP3SR7_11_8,	RLIN313TX_B),
	PINMUX_IPSR_GPSR(IP3SR7_11_8,	FLXA0RXDB),

	PINMUX_IPSR_GPSR(IP3SR7_15_12,	CAN13RX_INTP13_B),
	PINMUX_IPSR_GPSR(IP3SR7_15_12,	RLIN313RX_INTP29_B),
	PINMUX_IPSR_GPSR(IP3SR7_15_12,	FLXA0RXDA),

	PINMUX_IPSR_GPSR(IP3SR7_19_16,	CAN14TX_B),
	PINMUX_IPSR_GPSR(IP3SR7_19_16,	RLIN314TX_B),
	PINMUX_IPSR_GPSR(IP3SR7_19_16,	FLXA0TXDB),

	PINMUX_IPSR_GPSR(IP3SR7_23_20,	CAN14RX_INTP14_B),
	PINMUX_IPSR_GPSR(IP3SR7_23_20,	RLIN314RX_INTP30_B),
	PINMUX_IPSR_GPSR(IP3SR7_23_20,	FLXA0TXDA),

	PINMUX_IPSR_GPSR(IP3SR7_27_24,	CAN15TX_B),
	PINMUX_IPSR_GPSR(IP3SR7_27_24,	RLIN315TX_B),
	PINMUX_IPSR_GPSR(IP3SR7_27_24,	FLXA0TXENB),

	PINMUX_IPSR_GPSR(IP3SR7_31_28,	CAN15RX_INTP15_B),
	PINMUX_IPSR_GPSR(IP3SR7_31_28,	RLIN315RX_INTP31_B),
...
#define FM(x)		FN_##x
	...
	{ PINMUX_CFG_REG("GPSR4", 0xffd90040, 32, 1, GROUP(
		0, 0,
		GP_4_30_FN,	GPSR4_30,
		GP_4_29_FN,	GPSR4_29,
		GP_4_28_FN,	GPSR4_28,
	...
	{ PINMUX_CFG_REG("GPSR5", 0xffd90840, 32, 1, GROUP(
		0, 0,
		0, 0,
		0, 0,
		0, 0,
	...
	{ PINMUX_CFG_REG("GPSR6", 0xffd91040, 32, 1, GROUP(
		GP_6_31_FN,	GPSR6_31,
		0, 0,
		0, 0,
		0, 0,
	...
	{ PINMUX_CFG_REG("GPSR7", 0xffd91840, 32, 1, GROUP(
		GP_7_31_FN,	GPSR7_31,
		GP_7_30_FN,	GPSR7_30,
		GP_7_29_FN,	GPSR7_29,
		GP_7_28_FN,	GPSR7_28,
...
#define FM(x)		FN_##x,
	...
	{ PINMUX_CFG_REG("IP0SR4", 0xffd90060, 32, 4, GROUP(
		IP0SR4_31_28
		IP0SR4_27_24
		IP0SR4_23_20
		IP0SR4_19_16
	...
	{ PINMUX_CFG_REG("IP1SR4", 0xffd90064, 32, 4, GROUP(
		IP1SR4_31_28
		IP1SR4_27_24
		IP1SR4_23_20
		IP1SR4_19_16
	...
	{ PINMUX_CFG_REG("IP2SR4", 0xffd90068, 32, 4, GROUP(
		IP2SR4_31_28
		IP2SR4_27_24
		IP2SR4_23_20
		IP2SR4_19_16
	...
	{ PINMUX_CFG_REG("IP3SR4", 0xffd9006c, 32, 4, GROUP(
		IP3SR4_31_28
		IP3SR4_27_24
		IP3SR4_23_20
		IP3SR4_19_16
	...
	{ PINMUX_CFG_REG("IP0SR5", 0xffd90860, 32, 4, GROUP(
		IP0SR5_31_28
		IP0SR5_27_24
		IP0SR5_23_20
		IP0SR5_19_16
	...
	{ PINMUX_CFG_REG("IP0SR6", 0xffd91060, 32, 4, GROUP(
		IP0SR6_31_28
		IP0SR6_27_24
		IP0SR6_23_20
		IP0SR6_19_16
	...
	{ PINMUX_CFG_REG("IP1SR6", 0xffd91064, 32, 4, GROUP(
		IP1SR6_31_28
		IP1SR6_27_24
		IP1SR6_23_20
		IP1SR6_19_16
	...
	{ PINMUX_CFG_REG("IP2SR6", 0xffd91068, 32, 4, GROUP(
		IP2SR6_31_28
		IP2SR6_27_24
		IP2SR6_23_20
		IP2SR6_19_16
	...
	{ PINMUX_CFG_REG("IP0SR7", 0xffd91860, 32, 4, GROUP(
		IP0SR7_31_28
		IP0SR7_27_24
		IP0SR7_23_20
		IP0SR7_19_16
	...
	{ PINMUX_CFG_REG("IP1SR7", 0xffd91864, 32, 4, GROUP(
		IP1SR7_31_28
		IP1SR7_27_24
		IP1SR7_23_20
		IP1SR7_19_16
	...
	{ PINMUX_CFG_REG("IP2SR7", 0xffd91868, 32, 4, GROUP(
		IP2SR7_31_28
		IP2SR7_27_24
		IP2SR7_23_20
		IP2SR7_19_16
	...
	{ PINMUX_CFG_REG("IP3SR7", 0xffd9186c, 32, 4, GROUP(
		IP3SR7_31_28
		IP3SR7_27_24
		IP3SR7_23_20
		IP3SR7_19_16
...
static const struct pinmux_drive_reg pinmux_drive_regs[] = {
	...
	{ PINMUX_DRIVE_REG("DRV0CTRL4", 0xffd90080) {
	...
	{ PINMUX_DRIVE_REG("DRV1CTRL4", 0xffd90084) {
	...
	{ PINMUX_DRIVE_REG("DRV2CTRL4", 0xffd90088) {
	...
	{ PINMUX_DRIVE_REG("DRV3CTRL4", 0xffd9008c) {
		{ RCAR_GP_PIN(4, 30), 24, 3 },	/* MSPI1CSS1_B */
		{ RCAR_GP_PIN(4, 29), 20, 3 },	/* MSPI1CSS2_B */
		{ RCAR_GP_PIN(4, 28), 16, 3 },	/* MSPI1SC */
		{ RCAR_GP_PIN(4, 27), 12, 3 },	/* MSPI1CSS0_B */
		{ RCAR_GP_PIN(4, 26),  8, 3 },	/* MSPI1SO_MSPI1DCS */
		{ RCAR_GP_PIN(4, 25),  4, 3 },	/* MSPI1SI_B */
		{ RCAR_GP_PIN(4, 24),  0, 3 },	/* MSPI0CSS0 */
	} },
	{ PINMUX_DRIVE_REG("DRV0CTRL5", 0xffd90880) {
	...
	{ PINMUX_DRIVE_REG("DRV1CTRL5", 0xffd90884) {
	...
	{ PINMUX_DRIVE_REG("DRV2CTRL5", 0xffd90888) {
	...
	{ PINMUX_DRIVE_REG("DRV0CTRL6", 0xffd91080) {
		{ RCAR_GP_PIN(6,  7), 28, 3 },	/* RLIN34RX_INTP20_B */
		{ RCAR_GP_PIN(6,  6), 24, 3 },	/* RLIN34TX_B */
		{ RCAR_GP_PIN(6,  5), 20, 3 },	/* RLIN35RX_INTP21_B */
		{ RCAR_GP_PIN(6,  4), 16, 3 },	/* RLIN35TX_B */
		{ RCAR_GP_PIN(6,  3), 12, 3 },	/* RLIN36RX_INTP22_B */
		{ RCAR_GP_PIN(6,  2),  8, 3 },	/* RLIN36TX_B */
		{ RCAR_GP_PIN(6,  1),  4, 3 },	/* RLIN37RX_INTP23_B */
		{ RCAR_GP_PIN(6,  0),  0, 3 },	/* RLIN37TX_B */
	} },
	{ PINMUX_DRIVE_REG("DRV1CTRL6", 0xffd91084) {
	...
	{ PINMUX_DRIVE_REG("DRV2CTRL6", 0xffd91088) {
		{ RCAR_GP_PIN(6, 22), 24, 3 },	/* NMI1_B */
		{ RCAR_GP_PIN(6, 21), 20, 3 },	/* INTP32_B */
		{ RCAR_GP_PIN(6, 20), 16, 3 },	/* INTP33_B */
		{ RCAR_GP_PIN(6, 19), 12, 3 },	/* INTP34_B */
		{ RCAR_GP_PIN(6, 18),  8, 3 },	/* INTP35_B */
		{ RCAR_GP_PIN(6, 17),  4, 3 },	/* INTP36_B */
		{ RCAR_GP_PIN(6, 16),  0, 3 },	/* INTP37_B */
	} },
	{ PINMUX_DRIVE_REG("DRV3CTRL6", 0xffd9108c) {
		{ RCAR_GP_PIN(6, 31), 28, 3 },	/* PRESETOUT1_N */
	} },
	{ PINMUX_DRIVE_REG("DRV0CTRL7", 0xffd91880) {
	...
	{ PINMUX_DRIVE_REG("DRV1CTRL7", 0xffd91884) {
	...
	{ PINMUX_DRIVE_REG("DRV2CTRL7", 0xffd91888) {
	...
	{ PINMUX_DRIVE_REG("DRV3CTRL7", 0xffd9188c) {
		{ RCAR_GP_PIN(7, 31), 28, 3 },	/* CAN15RX_INTP15_B */
		{ RCAR_GP_PIN(7, 30), 24, 3 },	/* CAN15TX_B */
		{ RCAR_GP_PIN(7, 29), 20, 3 },	/* CAN14RX_INTP14_B */
		{ RCAR_GP_PIN(7, 28), 16, 3 },	/* CAN14TX_B */
		{ RCAR_GP_PIN(7, 27), 12, 3 },	/* CAN13RX_INTP13_B */
		{ RCAR_GP_PIN(7, 26),  8, 3 },	/* CAN13TX_B */
		{ RCAR_GP_PIN(7, 25),  4, 3 },	/* CAN12RX_INTP12_B */
		{ RCAR_GP_PIN(7, 24),  0, 3 },	/* CAN12TX_B */
	} },
	{ /* sentinel */ },
};
...
static const struct pinmux_bias_reg pinmux_bias_regs[] = {
	...
	{ PINMUX_BIAS_REG("PUEN4", 0xffd900c0, "PUD4", 0xffd900e0) {
		...
		[25] = RCAR_GP_PIN(4, 25),	/* MSPI1SI_B */
		[26] = RCAR_GP_PIN(4, 26),	/* MSPI1SO_MSPI1DCS */
		[27] = RCAR_GP_PIN(4, 27),	/* MSPI1CSS0_B */
		[28] = RCAR_GP_PIN(4, 28),	/* MSPI1SC */
		[29] = RCAR_GP_PIN(4, 29),	/* MSPI1CSS2_B */
		[30] = RCAR_GP_PIN(4, 30),	/* MSPI1CSS1_B */
		[31] = SH_PFC_PIN_NONE,
	} },
	{ PINMUX_BIAS_REG("PUEN5", 0xffd908c0, "PUD5", 0xffd908e0) {
	...
	{ PINMUX_BIAS_REG("PUEN6", 0xffd910c0, "PUD6", 0xffd910e0) {
		[ 0] = RCAR_GP_PIN(6,  0),	/* RLIN37TX_B */
		[ 1] = RCAR_GP_PIN(6,  1),	/* RLIN37RX_INTP23_B */
		[ 2] = RCAR_GP_PIN(6,  2),	/* RLIN36TX_B */
		[ 3] = RCAR_GP_PIN(6,  3),	/* RLIN36RX_INTP22_B */
		[ 4] = RCAR_GP_PIN(6,  4),	/* RLIN35TX_B */
		[ 5] = RCAR_GP_PIN(6,  5),	/* RLIN35RX_INTP21_B */
		[ 6] = RCAR_GP_PIN(6,  6),	/* RLIN34TX_B */
		[ 7] = RCAR_GP_PIN(6,  7),	/* RLIN34RX_INTP20_B */
		...
		[16] = RCAR_GP_PIN(6, 16),	/* INTP37_B */
		[17] = RCAR_GP_PIN(6, 17),	/* INTP36_B */
		[18] = RCAR_GP_PIN(6, 18),	/* INTP35_B */
		[19] = RCAR_GP_PIN(6, 19),	/* INTP34_B */
		[20] = RCAR_GP_PIN(6, 20),	/* INTP33_B */
		[21] = RCAR_GP_PIN(6, 21),	/* INTP32_B */
		[22] = RCAR_GP_PIN(6, 22),	/* NMI1_B */
		[23] = SH_PFC_PIN_NONE,
		[24] = SH_PFC_PIN_NONE,
		[25] = SH_PFC_PIN_NONE,
		[26] = SH_PFC_PIN_NONE,
	...
	{ PINMUX_BIAS_REG("PUEN7", 0xffd918c0, "PUD7", 0xffd918e0) {
		...
		[24] = RCAR_GP_PIN(7, 24),	/* CAN12TX_B */
		[25] = RCAR_GP_PIN(7, 25),	/* CAN12RX_INTP12_B */
		[26] = RCAR_GP_PIN(7, 26),	/* CAN13TX_B */
		[27] = RCAR_GP_PIN(7, 27),	/* CAN13RX_INTP13_B */
		[28] = RCAR_GP_PIN(7, 28),	/* CAN14TX_B */
		[29] = RCAR_GP_PIN(7, 29),	/* CAN14RX_INTP14_B */
		[30] = RCAR_GP_PIN(7, 30),	/* CAN15TX_B */
		[31] = RCAR_GP_PIN(7, 31),	/* CAN15RX_INTP15_B */
	} },
	{ /* sentinel */ },
};
