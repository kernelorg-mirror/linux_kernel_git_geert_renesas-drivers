...
dev_info(dev, "Mapping power domain %u to SCMI power domain %u\n", id, map->fw_id);
	...
	dev_dbg(dev, "Power domain %u is %s\n", id, genpd->name);
...
dev_info(dev, "SCMI power domain %u is %s\n", map[i].fw_id, genpd->name);
...
static const struct power_map_in r8a78000_mdlc_pere_power_fw_1_10_0[] = {
	{ 0, 12 },	/* PD_UFS0 */
	{ 1, 13 },	/* PD_UFS1 */
	{ -1 },
};

static const struct mod_map r8a78000_mdlc_pere_mod_fw_1_10_0[] = {
...
static const struct mod_map r8a78000_mdlc_perw_mod_fw_1_10_0[] = {
...
static const struct r8a78000_mdlc_info r8a78000_mdlc_fw_1_10_0[] = {
	{
		.base = 0xc3060000 /* mdlc_vipn */,
		/* FIXME .power_map = r8a78000_mdlc_vipn_power_fw_1_10_0, */
		/* FIXME .mod_map = r8a78000_mdlc_vipn_mod_fw_1_10_0, */
	}, {
		.base = 0xc3460000 /* mdlc_vips */,
		/* FIXME .power_map = r8a78000_mdlc_vips_power_fw_1_10_0, */
		/* FIXME .mod_map = r8a78000_mdlc_vips_mod_fw_1_10_0, */
	}, {
		.base = 0xc5000000 /* mdlc_vio */,
		/* FIXME .power_map = r8a78000_mdlc_vio_power_fw_1_10_0, */
		/* FIXME .mod_map = r8a78000_mdlc_vio_mod_fw_1_10_0, */
	}, {
		.base = 0xc08f0000 /* mdlc_pere */,
		.power_map = r8a78000_mdlc_pere_power_fw_1_10_0,
		.mod_map = r8a78000_mdlc_pere_mod_fw_1_10_0,
	}, {
		.base = 0xc05d0000 /* mdlc_perw */,
		.mod_map = r8a78000_mdlc_perw_mod_fw_1_10_0,
// FIXME We don't need all of them from the start; only add when used/tested
#if 0
	}, {
		...
		/* FIXME .power_map = r8a78000_mdlc_hscn_power_fw_1_10_0, */
		/* FIXME .mod_map = r8a78000_mdlc_hscn_mod_fw_1_10_0, */
	}, {
		.base = 0x19440000 /* mdlc_rt */,
		/* FIXME .power_map = r8a78000_mdlc_rt_power_fw_1_10_0, */
		/* FIXME .mod_map = r8a78000_mdlc_rt_mod_fw_1_10_0, */
	}, {
		.base = 0xc6480000 /* mdlc_top */,
		/* FIXME .mod_map = r8a78000_mdlc_top_mod_fw_1_10_0, */
	}, {
		.base = 0xde200000 /* mdlc_hscs */,
		/* FIXME .power_map = r8a78000_mdlc_hscs_power_fw_1_10_0, */
		/* FIXME .mod_map = r8a78000_mdlc_hscs_mod_fw_1_10_0, */
	}, {
		.base = 0xc1990000 /* mdlc_imn */,
		/* FIXME .power_map = r8a78000_mdlc_imn_power_fw_1_10_0, */
		/* FIXME .mod_map = r8a78000_mdlc_imn_mod_fw_1_10_0, */
	}, {
		.base = 0xc1d90000 /* mdlc_ims */,
		/* FIXME .power_map = r8a78000_mdlc_ims_power_fw_1_10_0, */
		/* FIXME .mod_map = r8a78000_mdlc_ims_mod_fw_1_10_0, */
	}, {
		.base = 0xcb510000 /* mdlc_gpc */,
		/* FIXME .power_map = r8a78000_mdlc_gpc_power_fw_1_10_0, */
		/* FIXME .mod_map = r8a78000_mdlc_gpc_mod_fw_1_10_0, */
	}, {
		.base = 0xcbe90000 /* mdlc_dsp */,
		/* FIXME .power_map = r8a78000_mdlc_dsp_power_fw_1_10_0, */
		/* FIXME .mod_map = r8a78000_mdlc_dsp_mod_fw_1_10_0, */
	}, {
		.base = 0xe9980000 /* mdlc_mm */,
		/* FIXME .mod_map = r8a78000_mdlc_mm_mod_fw_1_10_0, */
	}, {
		.base = 0xd2c30000 /* mdlc_npu0 */,
		/* FIXME .power_map = r8a78000_mdlc_npu0_power_fw_1_10_0, */
		/* FIXME .mod_map = r8a78000_mdlc_npu0_mod_fw_1_10_0, */
	}, {
		.base = 0xd6c30000 /* mdlc_npu1 */,
		/* FIXME .power_map = r8a78000_mdlc_npu1_power_fw_1_10_0, */
		/* FIXME .mod_map = r8a78000_mdlc_npu1_mod_fw_1_10_0, */
	}, {
		.base = 0xca410000 /* mdlc_cmnn */,
		/* FIXME .power_map = r8a78000_mdlc_cmnn_power_fw_1_10_0, */
		/* FIXME .mod_map = r8a78000_mdlc_cmnn_mod_fw_1_10_0, */
	}, {
		.base = 0xca510000 /* mdlc_cmns */,
		/* FIXME .power_map = r8a78000_mdlc_cmns_power_fw_1_10_0, */
		/* FIXME .mod_map = r8a78000_mdlc_cmns_mod_fw_1_10_0, */
	}, {
		.base = 0xc1330000 /* mdlc_scp */,
		/* FIXME .mod_map = r8a78000_mdlc_scp_mod_fw_1_10_0, */
	}, {
		.base = 0xc1338000 /* mdlc_aon */,
		/* FIXME .mod_map = r8a78000_mdlc_aon_mod_fw_1_10_0, */
#endif
	},
	{ 0 }
};
...
static const struct fw_map r8a78000_mdlc_fw_map[] = {
	{ 0x010a0000, r8a78000_mdlc_fw_1_10_0 },	/* SCP FW SDKv4.28.0 */
	{ 0, NULL }
};
